        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('mymediajhipApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-mymediajhipApp-error');
                                var entityKey = httpResponse.headers('X-mymediajhipApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('mymediajhipApp.' + fieldError.objectName + '.' + convertedField);
