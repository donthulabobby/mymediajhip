package com.bobbysnehacorp.mymedia.config;

import com.bobbysnehacorp.mymedia.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.bobbysnehacorp.mymedia.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.bobbysnehacorp.mymedia.repository.search")
