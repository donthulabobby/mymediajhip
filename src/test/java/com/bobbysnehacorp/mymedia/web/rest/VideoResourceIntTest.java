...
public class VideoResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_DATE_ADDED = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneId.systemDefault());
    private static final ZonedDateTime UPDATED_DATE_ADDED = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    private static final String DEFAULT_DATE_ADDED_STR = dateTimeFormatter.format(DEFAULT_DATE_ADDED);
    ...
    public void initTest() {
        ...
        video.setDate_added(DEFAULT_DATE_ADDED);
    ...
    public void createVideo() throws Exception {
        ...
        assertThat(testVideo.getDate_added()).isEqualTo(DEFAULT_DATE_ADDED);
    ...
    @Test
    @Transactional
    public void checkDate_addedIsRequired() throws Exception {
        int databaseSizeBeforeTest = videoRepository.findAll().size();
        // set the field null
        video.setDate_added(null);
    ...
    public void getAllVideos() throws Exception {
        ...
        restVideoMockMvc.perform(get("/api/videos?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].date_added").value(hasItem(DEFAULT_DATE_ADDED_STR)))
    ...
    public void getVideo() throws Exception {
        ...
        restVideoMockMvc.perform(get("/api/videos/{id}", video.getId()))
            ...
            .andExpect(jsonPath("$.date_added").value(DEFAULT_DATE_ADDED_STR))
    ...
    public void updateVideo() throws Exception {
        ...
        video.setDate_added(UPDATED_DATE_ADDED);
        ...
        assertThat(testVideo.getDate_added()).isEqualTo(UPDATED_DATE_ADDED);
